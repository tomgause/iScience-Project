...
train.months <- unique(train.all.predictions$index)[1:320] # 335 before filter
...
# We're going to subset all of the data into data.matrix. This will make
# Minibatching MUCH faster!
data.matrix <- array(list(), dim=c(9, 51))
