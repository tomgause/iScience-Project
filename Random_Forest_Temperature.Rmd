...
```{r}
hindcast_data <- readRDS("./data/hindcast_all.rds")
...
Divide into training and testing data set. Total data is ~ 1 billion rows. 
Train on: forecast_targets 1984-01 to 2006-12
Test on: forecast_targets 2007-01 to END

```{r}
training.data <- hindcast_data %>% 
  filter(forecast_target < "2007-01-01")%>%
  filter(forecast_target >= "1984-01-01")

testing.data <- hindcast_data%>%
  filter(forecast_target >= "2007-01-01")
```
