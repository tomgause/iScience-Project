### make_data_CNN_Vermont.R
# Tom Gause, Acadia Hegedus, and Katelyn Mei
# last edited 5/04/2022
...
train_cells <- readRDS("./data/train_subset_Vermont_CNN_2022-05-04_19-42-38.RDS") %>%
...
filename <- paste0("./data/", "test_subset_CNN", currentTime, ".RDS")
